    ...
    <body>
        ...
        <table width="600px" align="center">
            ...
            <tr>
                ...
                <td></td>
                <td><input type="submit" value="se connecter" /><input type="reset" value="Reinitialiser"/><a href="monApplication.php?action=inscription"><input type="button" value="s'inscrire" /></a></td>
